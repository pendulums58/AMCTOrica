...
function s.purchase(tp)
	...
	if op==0 then
		...
		local common={101223186,87116928,101213303,101223181,101220033,14532163,12580477,18144506,102380,93039339}
		
		--언커먼 등급
			--삼전의 호, 페네트레이트 로드, 금지된 일적, 사탄클로스, 무한포영
		local uncommon={35269904,101223192,24299458,46565218,10045474}			
		
		--레어 등급
			--크샤트리라 펜리르, 매스 디나이얼, 삼전의 재
		local rare={32909498,101223243,25311006}
	elseif op==1 then
		--어드밴티지 확보 카드
			--오리카
			...
			--커먼 등급
				--운명을 거래하는 행상인 외 나머지
			local common={101223236,111310071,111310117,101223074,101223224,35261759,49238328,67169062,1372887,67616300,73287067,51335426,95376428,67443336,80036543,98444741,98954106,9064354}			
			--언커먼 등급
				--영원 커넥터, 모여드는 초목의 행진, 전생의 우연, 청룡신 아트라시온, 방랑병장 순간개방, 삼전의 재, 루드라의 마도서, 증식의 G, 원천 제간타, 심해의 파멸 자이루다
			local uncommon={101223222,101223146,101223169,111310144,103553012,25311006,23314220,23434538,101223034,101223032}
			--레어 등급
				--욕망의 항아리, 천사의 자비, 악몽의 신기루, 제육감, 퓨전 서포터, 드림 오브 크리스탈
			local rare={55144522,79571449,41482598,3280747,101223105,101223183}
	end
