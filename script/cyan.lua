...
pcall(dofile,"expansions/script/orica_constant.lua")
pcall(dofile,"expansions/script/cyan_utility.lua")
pcall(dofile,"expansions/script/key_system.lua")
--pcall(dofile,"expansions/script/proc_xyz_additional.lua")
-- pcall(dofile,"expansions/script/cyan_themeutils/interduo.lua")
pcall(dofile,"expansions/script/proc_access.lua")
pcall(dofile,"expansions/script/proc_pairing.lua")
pcall(dofile,"expansions/script/bossraid_battle.lua")
pcall(dofile,"expansions/script/cyan_themeutils/clocktower.lua")
pcall(dofile,"expansions/script/cyan_themeutils/starsnow.lua")
pcall(dofile,"expansions/script/cyan_themeutils/nightmist.lua")
pcall(dofile,"expansions/script/cyan_themeutils/libertylane.lua")
pcall(dofile,"expansions/script/cyan_themeutils/raimei.lua")
pcall(dofile,"expansions/script/cyan_themeutils/draco.lua")
pcall(dofile,"expansions/script/cyan_themeutils/fragmata.lua")
pcall(dofile,"expansions/script/cyan_themeutils/celestia.lua")
pcall(dofile,"expansions/script/cyan_themeutils/diletant.lua")
pcall(dofile,"expansions/script/cyan_themeutils/companion.lua")
pcall(dofile,"expansions/script/cyan_themeutils/saintmirage.lua")
pcall(dofile,"expansions/script/cyan_themeutils/amass.lua")
pcall(dofile,"expansions/script/cyan_themeutils/furioso.lua")
pcall(dofile,"expansions/script/cyan_themeutils/sakura.lua")
pcall(dofile,"expansions/script/cyan_themeutils/emberfox.lua")
pcall(dofile,"expansions/script/cyan_themeutils/unity.lua")